...
**Latest demo:** [GitHub Releases](https://github.com/bymediadev/SoapBoxx/releases) — pick the zip for your OS:

- **Windows:** `SoapBoxx-Production-Studio-Demo-vX.Y.Z.zip`
- **macOS:** `SoapBoxx-Production-Studio-Demo-vX.Y.Z-mac.zip` → use `Launch SoapBoxx Production Studio Demo.command`
