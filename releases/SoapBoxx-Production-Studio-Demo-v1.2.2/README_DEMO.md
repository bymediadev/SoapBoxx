...
- Demo launches in `demo` bucket (settings/data isolated from production).
- No built-in expiry; distribute updated builds when you want testers on a newer version.
