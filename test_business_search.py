...
def test_business_search():
    ...
    print(f"✅ Company search completed: {len(company_results.get('results', []))} results")
    
    # Test LinkedIn search
    print("\n2. Testing LinkedIn Search...")
    linkedin_results = gr.search_business("Microsoft", "linkedin")
    print(f"✅ LinkedIn search completed: {len(linkedin_results.get('linkedin_profiles', []))} profiles")
    
    # Test executive search
    print("\n3. Testing Executive Search...")
    executive_results = gr.search_business("Microsoft", "executive")
    print(f"✅ Executive search completed: {len(executive_results.get('results', []))} results")
    ...
    print(f"✅ Comprehensive search completed: {len(all_results.get('results', []))} total results")
