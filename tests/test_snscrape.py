...
def test_snscrape():
    ...
    try:
        ...
        if not scraper.is_available():
            print("❌ snscrape not available. Please install with: pip install snscrape")
            return False
        ...
        if "error" in twitter_trends:
            ...
            print(f"✅ Twitter test successful! Found {twitter_trends.get('count', 0)} tweets")
        ...
        if "error" in reddit_trends:
            ...
            print(f"✅ Reddit test successful! Found {reddit_trends.get('count', 0)} posts")
