...
class BackendTester:
    ...
    def test_feedback_engine(self):
        ...
        try:
            ...
            assert "listener_feedback" in result, "Feedback should have listener_feedback"
    ...
    def _generate_report(self, passed, failed):
        ...
        report = {
            ...
            "config_status": {
                ...
                "issues": [] if self.results.get("Configuration", False) else ["OpenAI API key not configured"],
