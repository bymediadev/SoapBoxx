...
class PodcastAPIs:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    "service": "podchaser",
                    "query": query,
                    "results": data.get("data", {}).get("searchPodcasts", {}).get("edges", [])
                }
            else:
                return {"error": f"Podchaser API error: {response.status_code}"}
                
        except Exception as e:
            track_api_error(f"Podchaser search failed: {e}", component="podcast_apis", exception=e)
    ...
    def _search_listen_notes(self, query: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Listen Notes search failed: {e}", component="podcast_apis", exception=e)
    ...
    def _search_apple_podcasts(self, query: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Apple Podcasts search failed: {e}", component="podcast_apis", exception=e)
    ...
    def _search_google_podcasts(self, query: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Google Podcasts search failed: {e}", component="podcast_apis", exception=e)
    ...
    def _get_podchaser_details(self, podcast_id: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Podchaser details failed: {e}", component="podcast_apis", exception=e)
    ...
    def _get_listen_notes_details(self, podcast_id: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Listen Notes details failed: {e}", component="podcast_apis", exception=e)
    ...
    def _get_podchaser_trending(self) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    "service": "podchaser",
                    "trending": data.get("data", {}).get("trendingPodcasts", {}).get("edges", [])
                }
            else:
                return {"error": f"Podchaser API error: {response.status_code}"}
                
        except Exception as e:
            track_api_error(f"Podchaser trending failed: {e}", component="podcast_apis", exception=e)
    ...
    def _get_listen_notes_trending(self) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    "service": "listen_notes",
                    "trending": data.get("podcasts", [])
                }
            else:
                return {"error": f"Listen Notes API error: {response.status_code}"}
                
        except Exception as e:
            track_api_error(f"Listen Notes trending failed: {e}", component="podcast_apis", exception=e)
            return {"error": f"Listen Notes trending failed: {str(e)}"}
    
    def get_podcast_analytics(self, podcast_id: str, service: str = "podchaser") -> Dict:
    ...
    def _get_podchaser_analytics(self, podcast_id: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Podchaser analytics failed: {e}", component="podcast_apis", exception=e)
    ...
    def _get_listen_notes_analytics(self, podcast_id: str) -> Dict:
        ...
        try:
            ...
            track_api_error(f"Listen Notes analytics failed: {e}", component="podcast_apis", exception=e)
