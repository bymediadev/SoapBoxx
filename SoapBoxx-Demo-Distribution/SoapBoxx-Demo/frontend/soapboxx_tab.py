...
class SoapBoxxTab(QWidget):
    ...
    def test_microphone(self):
        ...
        try:
            ...
            self._show_user_friendly_error(
                "Microphone Test Failed", f"An unexpected error occurred: {str(e)}"
            )
        ...
        try:
            ...
            for question in extracted_questions:
                ...
                if (
                    question
                    and len(question) > 10
                    and question not in self._known_questions
                ):
    ...
    def _process_manual_extraction(self, transcript: str):
        ...
        try:
            if self._try_openai_question_extraction(transcript):
                ...
                self.status_label.setText(
                    "OpenAI extraction failed, using basic extraction"
                )
                self.status_label.setStyleSheet(
                    "color: #FFC107; font-weight: bold; padding: 5px 10px; background: #FFF3CD; border-radius: 4px;"
                )
